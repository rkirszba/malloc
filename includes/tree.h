...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/16 18:35:15 by rkirszba          #+#    #+#             */
/*   Updated: 2020/11/16 18:35:16 by rkirszba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rbt				*tree_get_recurse_func(t_rbt *root, void *content,
					t_rbt_compare *func);
...
t_rbt				*tree_insert_func(t_rbt *root, t_rbt *new_node,
					void *content, t_rbt_compare *func);
t_rbt				*tree_insert_func_ll(t_rbt *root, t_rbt *new_node,
					void *content, t_rbt_compare_long_long *func);
void				tree_insert_recurse_func(t_rbt *root, t_rbt *n,
					t_rbt_compare *func);
