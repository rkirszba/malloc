...
void		print_struct(void *mem, size_t nb_struct)
{
	size_t	i;
	i = 0;
	while (i < nb_struct)
	{
		printf("%lld ", ((t_test*)mem)->a);
		printf("%d ", ((t_test*)mem)->b);
		printf("%lu ", ((t_test*)mem)->c);
		printf("%c ", ((t_test*)mem)->d);
		printf("%lu", ((t_test*)mem)->e);
		printf("\n");
...
void		test_read(void *mem, size_t nb_struct)
{
	...
	while (i < nb_struct)
	{
		...
		else if (e != 23383204972)
		{
			printf("Corrupted fields e !!!\n");
			printf("i: %zu\n", i);
			printf("%lld ", ((t_test*)mem)->a);
			printf("%d ", ((t_test*)mem)->b);
			printf("%lu ", ((t_test*)mem)->c);
...
void		print_unit_test(t_alloc_test *tab, int r)
{
	static int		index = 0;
	// show_alloc_mem();
	// if (index > 2)
	// 	print_struct(tab[1].mem, tab[1].size);
